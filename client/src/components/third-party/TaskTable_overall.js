...
import { selectTabOverall } from './recoil';
...
function ReactTable({
  ...
  const [newDataActive, setNewDataActive] = useRecoilState(selectTabOverall);
  ...
  return (
    <>
      <div>
        {/* Render table row selection */}
        <TableRowSelection selected={Object.keys(selectedRowIds).length} onClick={handleCheckboxClick} />
        ...
        <Stack spacing={2}>
              ...
              <Grid container spacing={2} sx={{ marginBottom: '5px' }}>
                <Grid item xs={6}>
                  <Item
                    ...
                    isclicked={clickedItem === 'task' ? 1 : 0}
                  >
                ...
                <Grid item xs={6}>
                  <Item
                    ...
                    style={{ cursor: 'pointer' }}
                    isclicked={clickedItem === 'project' ? 1 : 0}
                  >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginLeft: '7px' }}>
                            ...
                            style={{
                              ...
                              minWidth:
                                column.id === fixColumnR
                                  ...
                                  : column.id === fixColumnR3
                                  ? '50px'
                                  : column.id === fixColumnL || column.id === fixColumnL2
                                  ? '58px'
                                  : '150px',
                              ...column.style
                            }}
