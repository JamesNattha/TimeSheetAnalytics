...
function ReactTable(props) {
  const { columns, data, getHeaderProps, renderRowSubComponent, handleAdd, nameCreateButton, sortColumn, checkProject, handleSelect } =
    props;
      ...
      <div>
        ...
        <Stack spacing={2}>
          ...
          >
            ...
            >
              {/* {checkProject && (user?.role === 'manager' || user?.role === 'management' || user?.role === 'super_admin') && (
                <div style={{ display: 'flex', padding: '0 0 0 7px', alignItems: 'center' }}>
                  <Button
                    variant="contained"
                    sx={{
                      width: '200px',
