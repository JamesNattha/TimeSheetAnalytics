...
// import logo from 'assets/images/undefined/logo_undefined.png';
import logo from 'assets/images/undefined/Vector.png';
// material-ui
...
const LogoMain = ({ reverse }) => {
  ...
  return (
     ...
     */
    <>
      <img src={logo} alt="Mantis" width="220px" />
      {/* <img src={theme.palette.mode === 'dark' ? logoDark : logo} alt="Mantis" width="220" /> */}
