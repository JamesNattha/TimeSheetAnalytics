...
import { useMediaQuery, Button, Stack, Table, TableBody, TableCell, TableHead, TableRow } from '@mui/material';
            ...
            {page.map((row, i) => {
              ...
              return (
                <Fragment key={i}>
                  ...
                  {'-----------------ตัว expand table อยู่ตรงนี้นาจา--------------------'}
                  {row.isExpanded && (
                    <TableRow>
