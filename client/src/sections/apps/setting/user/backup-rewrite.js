...
const Popup = ({ customer, handleClose }) => {
  ...
  const InviteSchema = Yup.object().shape({
    ...
    startWorkingDate: Yup.date().required('Start working date is required')
  });
    ...
    if (isCreating) {
      ...
      try {
        ...
        const data = {
          ...
          level: formik.values.level.toLowerCase(),
          ...
          <DialogContent>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                ...
                />
                {/* <FormHelperText sx={{ color: 'red' }}>{touched.email && errors.email}</FormHelperText> */}
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Autocomplete
                  id="level"
                  options={['Owner', 'Manager', 'Lead', 'Senior', 'Junior', 'Trainee']}
