...
const AddCustomer = ({ customer, onCancel }) => {
  ...
  console.log('นี่แหละหนาอะไร', customer);
          ...
          <DialogContent sx={{ p: 2.5 }}>
            ...
            <Grid item xs={12} md={8}>
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Stack spacing={1.25}>
                    <InputLabel htmlFor="work-name">Name</InputLabel>
                    <TextField
                      fullWidth
                      id="work-name"
                ...
                {console.log('เป็น อะไร วะะะะะะ', getFieldProps('startDate'))}
                <Grid item xs={12}>
                  <Grid container spacing={3}>
                    <Grid item xs={6}>
                      <Stack spacing={1.25}>
                        <InputLabel htmlFor="customer-start">Start Date</InputLabel>
                        <DesktopDatePicker
                          fullWidth
                          id="customer-start"
                          inputFormat="dd/MM/yyyy"
                          value={
                            customer && customer.startDate ? new Date(moment(values.startDate, 'DD/MM/yyyy').format('YYYY/MM/DD')) : null
                          }
                    ...
                    <Grid item xs={6}>
                      <Stack spacing={1.25}>
                        <InputLabel htmlFor="customer-end">End Date</InputLabel>
                        <DesktopDatePicker
                          fullWidth
                          id="customer-end"
                          inputFormat="dd/MM/yyyy"
                          value={
                            customer && customer.endDate ? new Date(moment(values.endDate, 'DD/MM/yyyy').format('YYYY/MM/DD')) : null
                          }
                          l
                ...
                <Grid item xs={12}>
                  <Stack spacing={1.25}>
                    <InputLabel htmlFor="customer-detail">Detail</InputLabel>
                    <TextField
                      fullWidth
                      id="customer-detail"
                      multiline
                ...
                <Grid item xs={12}>
                  <Stack spacing={1.25}>
                    <InputLabel htmlFor="work-note">Note</InputLabel>
                    <TextField
                      fullWidth
                      id="work-note"
